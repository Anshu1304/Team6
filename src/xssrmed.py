...
DVWA_PATH = r'C:\xampp\htdocs\dvwa\vulnerabilities\xss_r\source\medium.php'  # Update this to your actual DVWA installation path
...
def perform_xss_attack(session, payload):
    ...
    return target_url, response_status, response_text_snippet, payload in response.text
...
def run_xss_tests():
    ...
    # XSS payloads for medium security level
    payloads = [
