...
REPORT_FILE = 'xssstoremedoutput.txt'
DVWA_PATH = r'C:\xampp\htdocs\dvwa\vulnerabilities\xss_s\source\medium.php'  # Update this to your actual DVWA installation path
...
SESSION_ID = 'ciaee30bupv7ibqenpnhehf6c5'  # Ensure this is a valid session ID
