...
REPORT_FILE = 'csrflowoutput.txt'
DVWA_PATH = r'C:\xampp\htdocs\dvwa\vulnerabilities\csrf\source\low.php'
...
SESSION_ID = 'ciaee30bupv7ibqenpnhehf6c5'  # Replace with your actual session ID
